...
"""PyInstaller spec for Cracker's Toolkit GUI — Linux build.

Build on Debian/Ubuntu with:
    pip install pyinstaller PyQt6
    python -m PyInstaller crackers_toolkit_linux.spec --noconfirm

The output goes to dist/CrackersToolkit/
"""
...
# Data files that must be bundled alongside the binary
datas = [
...
exe = EXE(
    ...
    # No icon= on Linux (ELF binaries don't embed icons)
)
